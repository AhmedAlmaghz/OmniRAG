...
تطبيق ويب **Serverless بالكامل** مبني على **Next.js 15** يقدّم Hybrid RAG ثنائي اللغة (عربي/إنجليزي) مع **عزل تام لكل مستخدم** عبر خمس طبقات، وواجهة وكيل ذكي (**Agentic RAG**) تستهلك أدوات عبر بروتوكول **MCP 2026-07-28** عديم الحالة.
...
|---|---|---|---|
| إطار العمل | **Next.js** | 15.x مع App Router | دعم RSC، Edge Runtime، تكامل أصيل مع Vercel، Server Actions |
