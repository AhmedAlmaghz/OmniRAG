  ...
  const sourceTypes = [
    ...
    },
    {
      ...
      fields: [
        {
          key: 'bucketUrl',
          labelAr: 'مسار المستودع أو المجلد:',
          labelEn: 'Bucket Path or Folder URI:',
          type: 'text',
          required: true,
          placeholder: 's3://my-bucket/docs/ or /var/data/docs',
        },
        {
          key: 'fileTypes',
          labelAr: 'أنواع الملفات المسموحة (Extensions):',
          labelEn: 'Allowed File Extensions:',
          type: 'text',
          default: '.pdf,.docx,.txt,.md,.json,.csv',
        },
        {
          key: 'accessKey',
          labelAr: 'مفتاح الوصول / Access Key ID:',
