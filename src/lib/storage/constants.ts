...
تلتزم جميع الأنظمة المستضافة بالتشفير الكامل بأسلوب AES-256 أثناء التخزين وببروتوكول TLS 1.3 أثناء النقل، مع عزل صارم لبيانات كل مستأجر على مستوى التطبيق: يُشتق نطاق المستأجر من الجلسة الموثّقة ولا يُقبل من مدخلات العميل، ويُسجَّل كل حدث أمني في سجل تدقيق.`,
    sourceType: 'file',
    language: 'ar',
    status: 'indexed',
    chunkCount: 3,
...
export const INITIAL_CHUNKS: DocumentChunk[] = [
  ...
  },
  {
    ...
    documentTitle: 'اتفاقية عدم الإفصاح والسرية NDA (2026)',
    content:
      'المادة 3: تلتزم جميع الأنظمة المستضافة بالتشفير الكامل بأسلوب AES-256 أثناء التخزين وببروتوكول TLS 1.3 أثناء النقل، مع عزل صارم لبيانات كل مستأجر على مستوى التطبيق: يُشتق نطاق المستأجر من الجلسة الموثّقة ولا يُقبل من مدخلات العميل، ويُسجَّل كل حدث أمني في سجل تدقيق.',
    chunkIndex: 2,
    pageNumber: 2,
    language: 'ar',
    metadata: { section: 'التشفير والعزل' },
  },
  {
    id: 'chunk-002-1',
    tenantId: 'tenant-acme-01',
