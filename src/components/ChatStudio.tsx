...
الميزات المدعومة:
- 🧮 **الرموز والمعادلات الرياضية (MathJax & MathJax4Arabic):** مثل $E = mc^2$ مع زر تحويل فوري للرموز العربية.
- 💻 **الشفرات البرمجية:** مدمجة بمظهر داكن أنيق مع تحديد لغة البرمجة وزر النسخ.
- 🎬 **تطبيقات الوسائط:** تشغيل مباشر للصور والفيديوهات والصوتيات.
- 📚 **الاستشهادات المضمنة:** أرقام المصادر [1] قابلة للنقر لعرض التفاصيل.
...
Supported features:
- 🧮 **Math Equations (MathJax & MathJax4Arabic):** Formulas like $E = mc^2$ with Arabic notation toggle.
- 💻 **Syntax-Highlighted Code Blocks:** Dark mode with copy-to-clipboard.
- 🎬 **Embedded Media:** Direct playback for images, video, and audio.
- 📚 **Inline Citations:** Clickable source numbers [1] for instant details.
- 🔊 **Text-To-Speech (TTS) and Markdown Exports.**`,
  ...
  // only render it on large screens to keep focus on the conversation.
  const showRightInspector = mcpServers.length > 0 || sessionToolCalls.length > 0 || activeCitation !== null;
