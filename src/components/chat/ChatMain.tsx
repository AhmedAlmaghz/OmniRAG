...
const modeLabelKeys: Record<ChatMode, string> = {
  hybrid: 'chat.modeHybrid',
  private: 'chat.modePrivate',
  general: 'chat.modeGeneral',
  analysis: 'chat.modeAnalysis',
};

const modeLabel = (m: ChatMode, lang: 'ar' | 'en') => t(lang, modeLabelKeys[m]);
    ...
    <div className="flex flex-col h-full overflow-hidden bg-slate-50/30 relative" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="no-print p-2 border-b border-slate-200 bg-white/80 backdrop-blur-sm flex items-center justify-between gap-2 shrink-0">
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          {onToggleSidebar && (
            <button
              ...
              title={t(lang, 'chat.openHistoryTitle')}
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            title={t(lang, 'chat.customizeSourcesTitle')}
          >
          ...
          {onSaveToSources && (
            <button
              ...
              title={t(lang, 'chat.saveToSourcesTitle')}
            >
              {isSavingToSources ? (
          ...
          <button
            ...
            title={t(lang, 'chat.printChatTitle')}
          >
          ...
          <button
            ...
            title={t(lang, 'chat.exportPdfTitle')}
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-white border border-slate-200 hover:bg-slate-100 text-slate-600 transition cursor-pointer flex items-center justify-center"
            title={t(lang, 'chat.exportJsonTitle')}
          >
          ...
          {onToggleFullscreen && (
            <button
              ...
              title={t(lang, isFullscreen ? 'chat.exitFullscreenTitle' : 'chat.fullscreenTitle')}
            >
            ...
            <div className="my-3 p-4 bg-amber-50 border-2 border-amber-300 rounded-2xl shadow-sm text-slate-800 animate-fadeIn">
              <div className="flex items-start justify-between gap-3 mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-amber-900">{t(lang, 'chat.approvalRequiredTitle')}</h4>
                    <p className="text-[11px] text-amber-800">{t(lang, 'chat.approvalRequiredDesc')}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                >
                  ...
                  <span>{t(lang, 'chat.authorize')}</span>
                </button>
              </div>
            </div>
          )}
          ...
          {isLoading && (
            <div className="flex items-center gap-3 text-xs text-slate-500 animate-message-appear">
              ...
              <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-2xl px-4 py-3 shadow-sm">
                ...
                />
                <span className="text-[11px] text-slate-500 ml-1">{t(lang, 'chat.thinking')}</span>
              </div>
            </div>
          )}
      ...
      {isFullscreen && (
        <div
          ...
          role="toolbar"
          aria-label={t(lang, 'chat.fullscreenToolsAria')}
        >
          <button
            type="button"
            onClick={onPrintChat}
          ...
          <button
            ...
            title={t(lang, 'chat.exportAsPdfTitle')}
          >
            {isExportingPdf ? <RotateCcw className="w-4 h-4 animate-spin" /> : <FileDown className="w-4 h-4" />}
          </button>
          ...
          <button
            ...
            title={t(lang, 'chat.decreaseTextTitle')}
          >
          ...
          <button
            ...
            className="p-2 rounded-xl text-slate-300 hover:text-white hover:bg-slate-700/70 transition cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            title={t(lang, 'chat.increaseTextTitle')}
          >
          ...
          <button
            ...
            title={t(lang, 'chat.exitFullscreenTitle')}
          >
            <Minimize2 className="w-3.5 h-3.5" />
            <span>{t(lang, 'chat.exit')}</span>
          </button>
        </div>
      )}
      ...
      <div className="no-print px-3 pb-2 pt-1 bg-gradient-to-t from-white via-white to-transparent shrink-0">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="relative group/mode ml-1.5 rtl:ml-0 rtl:mr-1.5 mb-1">
              <button
                ...
                title={t(lang, 'chat.chatModeTitle')}
              >
            ...
            {isLoading && onStopGeneration ? (
              <button
                ...
                title={t(lang, 'chat.stopGeneratingTitle')}
              >
          ...
          <div className="mt-1.5 text-center text-[10px] text-slate-400 font-mono flex items-center justify-center gap-1.5">
            ...
            <span>{t(lang, 'chat.memoryActive')}</span>
            ...
            {onRegenerate && !isLoading && messages.some((m) => m.role === 'assistant') && (
              <button
                ...
                title={t(lang, 'chat.regenerateTitle')}
              >
                <RotateCcw className="w-3 h-3" />
                <span>{t(lang, 'chat.regenerate')}</span>
              </button>
            )}
            {/* Character counter */}
