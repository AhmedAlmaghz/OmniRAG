...
> **حد معروف — درع حقن التعليمات (H6/H6b):** طبقة حتمية regex رخيصة تعالج الأنماط الساذجة، ويمكن تجاوزها بإعادة الصياغة. هي **ليست ضابط أمان مطلقاً** ولا يجوز الاعتماد عليها وحدها؛ أمن الوكيل يقوم على الطبقات المتعاقبة: H1 TenantGate، الموافقة البشرية على أدوات T2/T3 ذات الآثار الجانبية، تنقيح PII، وعزل RLS. أي ترقية دلالية (مصنّف LLM للحقن) قرار معماري مستقبلي مرهون بالتكلفة وزمن الاستجابة.
